...
## Азбука и произношение \{#alphabet-and-pronunciation}
...
### Въпросителни и неопределителни местоимения \{#interrogative-and-indefinite-pronouns}
...
## Примерен текст: В ресторанта \{#sample-text-in-the-restaurant}
...
## Основен речник \{#basic-vocabulary}
