...
Имайте предвид, че междуславянската етимологична азбука не включва маркери за дължина или тон, нито включва специални букви за заемки от неславянски езици (като староцърковнославянски `ѳ` и `ѵ`, използвани само за гръцки думи, или `ü` за немски или френски думи).
