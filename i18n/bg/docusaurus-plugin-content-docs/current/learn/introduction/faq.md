...
Междуславянската латиница има само четири букви с диакритика: Č :ipa[t͡ʃ], Š :ipa[ʂ], Ž :ipa[ʒ], Ě :ipa[jɛ]. Някои хора обаче използват допълнителни диакритични знаци и букви, за да запомнят славянската етимология, така че понякога може да срещнете странни думи като :isv[ćuđi], :isv[otėc], :isv[dȯžď], :isv[gręź], :isv[bųde], :isv[hlåd], :isv[сѫглӑсък], :isv[тѣх], :isv[гѫбоѭ], :isv[показуѥт].
