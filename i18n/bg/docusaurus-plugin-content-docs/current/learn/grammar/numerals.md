...
* Числата 0-9 са показани в първата колона, с :isv[nula] за нула и :isv[jedin] до :isv[devet] за 1-9.
* Числата 11-19 се образуват чрез добавяне на :isv[-nadset] (произнася се :isv[-nacet]) към числата 1-9, както е показано във втората колона (например :isv[jedinnadset], :isv[dvanadset]).
* Десетиците (10-90) се състоят от :isv[deset] за 10, а за 20-90 — от числата 2-9 със суфикса :isv[-deset] (например :isv[dvadeset], :isv[trideset]), както е показано в третата колона.
* Стотиците (100-900) могат да се образуват по два начина, както е показано в четвъртата колона:
  * :isv[sto] за 100, а за 200-900 — чрез добавяне на числата 2-9 към :isv[-sto] (например :isv[dvasto], :isv[tristo])
  * Или чрез алтернативните форми със склонени окончания (например :isv[dvěstě], :isv[trista], :isv[petsot])

Думите за „хиляда”, „милион” и „милиард” са: `tyseč` (1000), `milion` (10⁶) и `miliard` (10⁹). Точно както в случая със стотиците, тези думи могат или не могат да бъдат склонени като съществителни. Въпреки че не е обичайно в славянските езици да се прави това, в случаи като `pet-tyseć` „5000” може да се добави тире за яснота.

Комбинации от тях винаги се правят от високо към ниско: хиляди – стотици – десетки – единици. Между десетиците и единиците може да се вмъкне думата `i` „и”. Например: `tri-tyseč četyristo petdeset (i) šest` „3,456”. Можете да видите повече примери в конвертора по-долу.
