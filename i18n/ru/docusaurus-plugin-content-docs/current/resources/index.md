...
## Сообщество и социальные сети \{#community-and-social-networks}
...
### Telegram-каналы \{#telegram-microblogs}

- [:notr[Pub "Medžuslovjanska Kapibara"]][7] – регулярно пополняется забавным контентом.
- [:notr[Zapisky srědnoevropskogo medžuslovjanina]][8] – микроблог Роберто Ломбино.
...
### Перевод песни \{#song-translations}

Пойте любимые песни в переводе на межславянский на сайте [:notr[LyricsTranslate]][12].
...
- Журнал ":notr[Slovjani]": [https://slovjani.info][16] - в нем есть несколько статей на межславянском языке, но это не журнал про язык.
...
### Средства склонения \{#declinators}
...
### Вы можете внести свой вклад тут \{#contributing}
...
Чтобы сделать обучение более увлекательным, ознакомьтесь с межславянским комиксом на [:notr[Slovene Online]][30].
