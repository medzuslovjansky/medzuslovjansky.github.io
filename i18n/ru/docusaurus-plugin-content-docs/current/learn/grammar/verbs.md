...
- Глаголы на `-iti` имеют `-jeny` вместо **\*-`iny`** (где **\*-`sjeny`, \*-`zjeny`, \*-`tjeny`, \*- `djeny`, \*-`stjeny`, \*-`zdjeny`** становятся **-`šeny`, -`ženy`, -`čeny`, -`dženy`, -`ščeny`, -`ždženy`**): _:isv[govoriti > govorjeny] «разговорный», :isv[ljubiti > ljubjeny] «любимый», `prositi > prošeny`_ «требуемый»
