...
### Основные окончания \{#basic-endings}
...
### Аналитический сравнительный анализ \{#analytic-comparative}
...
### Синтетический сравнительный анализ \{#synthetic-comparative}
...
### Нерегулярные сравнения \{#irregular-comparatives}
...
### Дополнительные формы \{#additional-forms}
