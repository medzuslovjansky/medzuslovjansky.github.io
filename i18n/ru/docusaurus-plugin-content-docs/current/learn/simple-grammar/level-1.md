...
## Алфавит и произношение \{#alphabet-and-pronunciation}
...
### Вопросительные и неопределенные местоимения \{#interrogative-and-indefinite-pronouns}
...
## Пример текста: В ресторане \{#sample-text-in-the-restaurant}
...
## Базовый словарный запас \{#basic-vocabulary}
