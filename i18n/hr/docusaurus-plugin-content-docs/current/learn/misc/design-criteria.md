...
### Internacionalni naspram slavenskog vokabulara \{#international-versus-slavic-vocabulary}
...
U međuslavenskom kontekstu neologizmi su riječi koje kao takve ne postoje ni u jednom od živih slavenskih jezika. Primjeri takvih riječi su portmanto riječi (na primjer :isv[katka] „patka“, iz ru. :ru[utka], polj. :pl[kaczka], južnoslavenski :zls[patka]), kalkovi iz neslavenskih jezika (na primjer :isv[kolokrěslo] „invalidska kolica“), kombinacije međuslavenskih korijena riječi s međuslavenskim afiksima koji ne postoje u slavenskom jeziku (na primjer :isv[gradnik] „stanovnik grada, građanin“), te riječi s više opisnog karaktera u slučajevima kada je nemoguće naći široko razumljivu slavensku riječ.

Mišljenja su različita o stupnju u kojemu su umjetno stvorene riječi prihvatljive u međuslavenskom; neki ih ljudi vole, drugi ih mrze. U rječniku nastojimo izbjegavati neologizme, osim ako nijedan od živih slavenskih jezika ne nudi riječ koja je razumljiva široj publici i koju drugi neće krivo razumjeti. Primjer je :isv[časina] „sat“ (starocrkvenoslavenski nudi dvije riječi: :isv[čas] i :isv[godina], ali prva znači „vrijeme“ na zapadnoslavenskom, potonja znači „godina“ na južnoslavenskom, dok srpskohrvatska riječ :hbs[sat] je turska riječ koja ostalim Slavenima uopće nije razumljiva).
