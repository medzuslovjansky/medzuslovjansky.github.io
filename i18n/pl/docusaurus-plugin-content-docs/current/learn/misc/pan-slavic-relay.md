...
# Pansłowiańska sztafeta

Pansłowiańska sztafeta odbyła się we wrześniu oraz październiku 2009 roku.

„Gra sztafetowa” jest zasadniczo odmianą gry telefonicznej: jeden pisze wiersz lub krótki fragment w swoim sztucznym języku i przekazuje go następnemu uczestnikowi. Ta osoba odszyfrowuje tekst, a następnie wysyła tłumaczenie w swoim języku do następnego w kolejce i tak dalej, aż zatoczy pełny krąg, zmienione, przekształcone niejako przez bogów i zawierające nową mądrość. Twórcy sztucznych języków grali w tę grę już prawie dwadzieścia razy. Ta sztafeta różni się nieco od innych, ponieważ składa się wyłącznie z pomocniczych języków słowiańskich. Każdy uczestnik miał 48 godzin na wykonanie zadania. Gdyby jego język wykorzystywał wiele ortografii (np. łacina i cyrylica), mógłby oczywiście wysłać obie.

## Oryginalny tekst w języku angielskim \{#original-english-text}

_Oto oryginalny angielski tekst autorstwa Mary Russel Mitford, napisany w pierwszej połowie XIX wieku. Oczywiście został skrócony i uproszczony o niektóre wyrażenia, które były zbyt trudne do wyrażenia w słowiańskim konlangu (języku sztucznym)._
...
## Rostisław Lewczenko – Slovianski \{#levcenko-slovianski}
...
#### Po zakończeniu gry w Sztafetę, dodano kilka tłumaczeń: \{#later-additions}
