...
Акрамя таго, у інфінітывах паўночнай араматызацыі заканчваюцца на `-ť` замест `-ti`, назоўны/вінавальны склон адзіночнага ліку прыметнікаў павінен быць `-e` замест `-o` (:isv[dobre detja] замест паўднёвага :isv[dobro děte]). Паўночная араматызацыя аддае перавагу адноснаму займенніку :isv[ktory], а паўднёвая — :isv[koj]. Сапраўды гэтак жа, у выпадку прэфікса `vy-`/`iz-`, першы арыентаваны на поўнач, а другі - на поўдзень. У паўднёвай араматызацыі прыназоўнік :isv[dlja] «за» варта замяніць на :isv[za].
