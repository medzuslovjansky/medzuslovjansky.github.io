...
## Алфавіт і вымаўленне \{#alphabet-and-pronunciation}
...
### Асабістыя займеннікі \{#personal-pronouns}
...
### Пытальныя і няпэўныя займеннікі \{#interrogative-and-indefinite-pronouns}
...
## Прыклад тэксту: У рэстаране \{#sample-text-in-the-restaurant}
...
## Базавы слоўнікавы запас \{#basic-vocabulary}
