...
### Асноўныя канчаткі \{#basic-endings}
...
## Ступені параўнання \{#degrees-of-comparison}
...
### Аналітычны параўнальны \{#analytic-comparative}
...
### Сінтэтычны параўнальны \{#synthetic-comparative}
...
### Нерэгулярныя параўнанні \{#irregular-comparatives}
...
### Дадатковыя формы \{#additional-forms}
