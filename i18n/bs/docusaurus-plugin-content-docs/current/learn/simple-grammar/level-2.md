...
- Prisvojne zamjenice :isv[moj] „moj”, :isv[tvoj] „tvoj, tvoj”, :isv[naš] „naš”, :isv[vaš] „tvoj (:abbr[pl.])”, :isv[svoj] „svoj” i :isv[čij] „čiji” dobijaju iste završetke kao i pridjevi (osim u muškom rodu): :isv[moj] (:abbr[m.]), :isv[moja] (:abbr[f.]), :isv[moje] (:abbr[n.]), :isv[moje] (:abbr[pl.] ). Isto važi i za upitnu zamjenicu :isv[koj] „koji”:
  - :isv[moj muž] „moj muž”
  - :isv[tvoja žena] „tvoja žena”
  - :isv[naše děte] „naše dijete”
  - :isv[koje prijatelji] „koji prijatelji”

- Prisvojne zamjenice trećeg lica (:isv[jego] „njegov, njegov”, :isv[jej] „ona”, :isv[jih] „njihov”) se ne mijenjaju (to je zato što ove riječi nisu striktno prisvojne zamjenice, već doslovno nešto znače kao "od njega" itd.):
  - :isv[jego žena] „njegova žena”
  - :isv[jih prijatelji] „njihovi prijatelji”

- Pokazna zamjenica :isv[toj] ima oblike :isv[ta] (:abbr[f.]), :isv[to] (:abbr[n.]) i :isv[te] (:abbr[pl.]), umjesto _\*:isv[toja], \*@@ 83..._ (isto važi, naravno, za :isv[tutoj] i :isv[tamtoj]):
...
- Broj :isv[jedin] „jedan” ima forme :isv[jedna] (:abbr[f.]) i :isv[jedno] (:abbr[n.]):
...
Kako bi bilo prijatno uroniti u ovaj srdačni osećaj ljubavi i nepoznatih navika, okupiti se i družiti se sa svim ovim jedinstvenim ljudima oko nas! Kao što ćemo poznavati sve kutke i skretanja sjenovitih ulica i sunčanih livada kojima svakodnevno prolazimo. Mala društvena grupa, a to je ruralno društvo, ono je čemu poezija i proza najviše duguju. Duga, razvučena ulica, koja vijuga po lepom, toplom danu, prelazi veliki, široki put, pun automobila i kamiona. Da li bi voleo da putuješ sa mnom, dragi čitaoče? Putovanje neće biti dugo. Počinjemo na kraju doline i odatle nastavljamo uz brdo.
:::
