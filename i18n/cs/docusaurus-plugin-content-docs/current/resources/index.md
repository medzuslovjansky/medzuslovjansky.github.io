...
## Komunitní a sociální sítě \{#community-and-social-networks}
...
- [:notr[Pub "Medžuslovjanska Kapibara"]][7] – pravidelně aktualizována o zábavný obsah.
...
### Překlady písní \{#song-translations}

Zpívejte spolu s překlady svých oblíbených písní v mezislovanštině na [:notr[LyricsTranslate]][12].
...
- Časopis ":notr[Slovjani]": [https://slovjani.info][16] - má několik článků v mezislovanštině, ale není to jazykový časopis.
...
Abyste si učení zpříjemnili, podívejte se na tento mezislovanský komiks na [:notr[Slovene Online]][30].
