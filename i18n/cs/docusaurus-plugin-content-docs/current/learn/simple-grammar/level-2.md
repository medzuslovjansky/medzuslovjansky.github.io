...
- Mužská koncovka je `-y` nebo `-i`. Toto je tvar uvedený ve slovníku:
  ...
  :isv[dobry muž] „dobrý člověk“

- ženský konec je `-a`:

  :isv[dobra žena] „hodná žena“

- Neutrální konec je `-e`:

  :isv[dobre děte] „hodné dítě“

- Pro všechna pohlaví je množné číslo `-e`:
  - :isv[dobre muži] „dobří muži“
  - :isv[dobre ženi] „hodná žena“
  - :isv[dobre děta] „hodné děti“

Totéž platí pro přídavná jména, platí také pro přivlastňovací, ukazovací, vztažná, neurčitá zájmena a také pro čísla.

- Přivlastňovací zájmena :isv[moj] „můj“, :isv[tvoj] „váš, váš“, :isv[naš] „náš“, :isv[vaš] „váš (:abbr[pl.])“, :isv[svoj] „vlastní“ a :isv[čij] „jehož“ mají stejné koncovky jako přídavná jména (kromě mužského rodu): :isv[moj] (:abbr[m.]), :isv[moja] (:abbr[f.]), :isv[moje] (:abbr[n.]), :isv[moje] (:abbr[pl.]). ). Totéž platí pro tázací zájmeno :isv[koj] „který“:
  - :isv[moj muž] „můj manžel“
  - :isv[tvoja žena] „vaše žena“
  - :isv[naše děte] „naše dítě“
  - :isv[koje prijatelji] „kteří přátelé“

- Přivlastňovací zájmena třetí osoby (:isv[jego] „jeho, jeho“, :isv[jej] „ona“, :isv[jih] „jejich“) se nemění (je to proto, že tato slova nejsou striktně přivlastňovacími zájmeny, ale doslova něco znamenají jako „jeho“ atd.):
  - :isv[jego žena] „jeho žena“
  - :isv[jih prijatelji] „jejich přátelé“

- Ukazovací zájmeno :isv[toj] má tvary :isv[ta] (:abbr[f.]), :isv[to] (:abbr[n.]) a :isv[te] (:abbr[pl.]), místo _\*:isv[toja], \*@@ 83..._ (totéž samozřejmě platí pro :isv[tutoj] a :isv[tamtoj]):
  - :isv[toj muž] „tento muž“
  - @87 „ta žena“
  - @88 „toto dítě“
  - :isv[te prijatelji] „tito přátelé“

- Vztažné zájmeno :isv[ktory] se chová jako přídavné jméno:
  - :isv[žena, ktora čita] „žena, která čte“
  - :isv[děte, ktore ja viděl] „dítě, které jsem viděl“

- Číslo :isv[jedin] „jedna“ má tvary :isv[jedna] (:abbr[f.]) a :isv[jedno] (:abbr[n.]):
...
V :notr[Slovianto] úrovni 1 jste se naučili, že přítomný čas se tvoří přidáním koncovky `-(e)t` ke kmeni: :isv[ja děla-t] "dělám", :isv[vy prosi-t] "prosíte", :isv[oni nes-et] "nesou". Slovanskému uchu to však zní nepřirozeně, protože všechny slovanské jazyky skloňují svá slovesa pro osobu a číslo. Chcete-li udělat lepší dojem, je možné hodně získat tím, že se také naučíte některé z těchto osobních konců.
...
Jak příjemné by bylo ponořit se do tohoto srdečného pocitu lásky a neznámých zvyků, setkat se a být přáteli se všemi těmito jedinečnými lidmi kolem nás! Stejně jako budeme znát všechna zákoutí a zákruty stinných ulic a slunných luk, které denně míjíme. Malé sociální skupině, kterou je venkovská společnost, vděčí poezie a próza nejvíce. Dlouhá, roztažená ulice, vinoucí se za pěkného teplého dne, křižující velkou, širokou silnici plnou aut a kamionů. Chtěl bys se mnou cestovat, milý čtenáři? Cesta nebude dlouhá. Začneme na konci údolí a odtud budeme pokračovat do kopce.
:::
