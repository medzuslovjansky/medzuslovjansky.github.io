...
## Азбука и изговор \{#alphabet-and-pronunciation}
...
### Прашливи и неопределени заменки \{#interrogative-and-indefinite-pronouns}
...
## Примерок текст: Во ресторанот \{#sample-text-in-the-restaurant}
...
## Основен вокабулар \{#basic-vocabulary}
