...
- Глаголите на `-iti` имаат `-jeny` наместо **\*-`iny`** (при што **\*-`sjeny`, \*-`zjeny`, \*-`tjeny`, \*- `djeny`, \*-`stjeny`, \*-`zdjeny`** стануваат **-`šeny`, -`ženy`, -`čeny`, -`dženy`, -`ščeny`, -`ždženy`**): _:isv[govoriti > govorjeny] „зборувано“, :isv[ljubiti > ljubjeny] „сакано“, `prositi > prošeny`_ „задолжително“
