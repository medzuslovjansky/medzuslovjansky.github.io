...
* Броевите 0-9 се прикажани во првата колона, со :isv[nula] за нула и :isv[jedin] до :isv[devet] за 1-9.
* Броевите 11-19 се формираат со додавање на :isv[-nadset] (се изговара :isv[-nacet]) на броевите 1-9, како што е прикажано во втората колона (на пример, :isv[jedinnadset], :isv[dvanadset]).
* Десетките (10-90) се состојат од :isv[deset] за 10, а за 20-90 од броевите 2-9 со наставката :isv[-deset] (на пример, :isv[dvadeset], :isv[trideset]), како што е прикажано во третата колона.
* Стотките (100-900) можат да се формираат на два начина, како што е прикажано во четвртата колона:
  * :isv[sto] за 100, а за 200-900 со додавање на броевите 2-9 на :isv[-sto] (на пример, :isv[dvasto], :isv[tristo])
  * Или со користење на алтернативните форми со флектирани наставки (на пример, :isv[dvěstě], :isv[trista], :isv[petsot])

Зборовите за „илјада“, „милион“ и „милиард“ се: `tyseč` (1000), `milion` (10⁶) и `miliard` (10⁹). Исто како и во случајот со стотиците, овие зборови може или не може да се наведнуваат како именки. Иако не е вообичаено во словенските јазици да се прави ова, во случаи како `pet-tyseć` „5000“ може да се додаде цртичка за јасност.

Комбинации од нив секогаш се прават од високо до ниско: илјадници – стотици – десетици – единици. Помеѓу десетките и оние, може да се вметне зборот `i` „и“. На пример: `tri-tyseč četyristo petdeset (i) šest` „3.456“. Повеќе примери може да видите во конверторот подолу.
