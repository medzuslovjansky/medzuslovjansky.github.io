...
- Moška končnica je `-y` ali `-i`. To je oblika, navedena v slovarju:
  ...
  :isv[dobry muž] "dober človek"

- Končnica v ženskem rodu je `-a`:

  :isv[dobra žena] "dobra ženska"

- Končnica srednjega rodu je `-e`:

  :isv[dobre děte] "priden otrok"

- Za vse spole je množinska končnica `-e`:
  - :isv[dobre muži] „dobri možje”
  - :isv[dobre ženi] „dobra ženska”
  - :isv[dobre děta] „dobri otroci”

Enako kot za pridevnike, velja tudi za svojilne, kazalne, odnosne, nedoločne zaimke, pa tudi za števila.

- Svojilni zaimki :isv[moj] „moj”, :isv[tvoj] „tvoj, tvoj”, :isv[naš] „naš”, :isv[vaš] „tvoj (:abbr[pl.])”, :isv[svoj] „svoj” in :isv[čij] „čigav” imajo enake končnice kot pridevniki (razen v moškem rodu): :isv[moj] (:abbr[m.]), :isv[moja] (:abbr[f.]), :isv[moje] (:abbr[n.]), :isv[moje] (:abbr[pl.]). ). Enako velja za vprašalni zaimek :isv[koj] „kateri”:
  - :isv[moj muž] „moj mož”
  - :isv[tvoja žena] „tvoja žena”
  - :isv[naše děte] „naš otrok”
  - :isv[koje prijatelji] "kateri prijatelji"

- Svojilni zaimki tretje osebe (:isv[jego] „njegov, njegov”, :isv[jej] „njen”, :isv[jih] „njihov”) se ne spreminjajo (to je zato, ker te besede niso strogo svojilni zaimki, ampak dobesedno nekaj pomenijo kot "od njega" itd.):
  - :isv[jego žena] „njegova žena”
  - :isv[jih prijatelji] „njihovi prijatelji”

- kazalni zaimek :isv[toj] ima oblike :isv[ta] (:abbr[f.]), :isv[to] (:abbr[n.]) in :isv[te] (:abbr[pl.]), namesto _\*:isv[toja], \*@@ 83..._ (seveda enako velja za :isv[tutoj] in :isv[tamtoj]):
  - :isv[toj muž] "ta moški"
  - :isv[ta žena] „ta ženska”
  - :isv[to děte] "ta otrok"
  - :isv[te prijatelji] „ti prijatelji”

- Odnosni zaimek :isv[ktory] se obnaša kot pridevnik:
  - :isv[žena, ktora čita] „ženska, ki bere”
  - :isv[děte, ktore ja viděl] "otrok, ki sem ga videl"

- Število :isv[jedin] „ena” ima obliko :isv[jedna] (:abbr[f.]) in :isv[jedno] (:abbr[n.]):
  - :isv[jedin muž] "en človek"
...
V :notr[Slovianto] stopnji 1 ste se naučili, da se sedanjik tvori z dodajanjem končnice `-(e)t` k korenu: :isv[ja děla-t] "jaz", :isv[vy prosi-t] "sprašujete", :isv[oni nes-et] "nosijo". Za slovansko uho pa se to sliši nenaravno, ker vsi slovanski jeziki sklanjajo svoje glagole za osebo in število. Če želite narediti boljši vtis, lahko veliko pridobite, če se naučite tudi nekaterih teh osebnih koncev.

Torej, čas je, da pozabite na konec `-t`! Namesto tega si zapomnite naslednje končnice: `-m`, `-š`, `-Ø`  (brez končnice) v prvi, drugi in tretji osebi ednine ter `-mo`, `-te`, `-ut`  v prvi, drugi in tretji osebi množine. Ko se koren konča na samoglasnik, vstavite `-j-` pred končnico `-ut`. Ko se koren konča na soglasnik, vstavite `-e-` pred preostale končnice. Oglejte si tabelo na desni za nekaj primerov.
...
Kako prijetno bi se bilo potopiti v ta prisrčen občutek ljubezni in neznanih navad, se zbrati in prijateljevati z vsemi temi edinstvenimi ljudmi okoli nas! Tako kot bomo poznali vse vogale in zavoje senčnih ulic in sončnih travnikov, mimo katerih se peljemo vsak dan. Majhna družbena skupina, to je podeželska družba, je tisto, čemur se poezija in proza najbolj zahvalita. Dolga, razpotegnjena ulica, ki se vije na lep, topel dan in prečka veliko, široko cesto, polno avtomobilov in tovornjakov. Bi rad potoval z mano, dragi bralec? Pot ne bo dolga. Začnemo na koncu doline, od tam pa nadaljujemo v hrib.
:::
