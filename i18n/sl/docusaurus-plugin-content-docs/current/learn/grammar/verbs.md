...
Včasih so pari vidikov nepravilni, na primer :isv[nazyvati] (impf.)/:isv[nazvati] (pf.) „klicati, imenovati”, :isv[prihoditi] (impf.)/:isv[prijdti] (pf.) „priti” , :isv[podimati] (impf.)/:isv[podjeti] (pf.) „prevzeti, lotiti se”.
