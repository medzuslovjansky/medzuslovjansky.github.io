...
## Komunitné a sociálne siete \{#community-and-social-networks}
...
### Telegramové mikroblogy \{#telegram-microblogs}

- [:notr[Pub "Medžuslovjanska Kapibara"]][7] – pravidelne aktualizovaný zábavným obsahom.
...
### Preklady piesní \{#song-translations}

Spievajte spolu s prekladmi svojich obľúbených piesní v interslovančine na [:notr[LyricsTranslate]][12].
...
- Časopis ":notr[Slovjani]": [https://slovjani.info][16] - má niekoľko článkov v interslovančine, ale nie je to jazykový časopis.
...
### Kontrola pravopisu \{#spell-checkers}
...
Aby bolo učenie príjemnejšie, pozrite si tento medzislovanský komiks na [:notr[Slovene Online]][30].
