...
### Основни завршеци \{#basic-endings}
...
## Степени поређења \{#degrees-of-comparison}
...
### Аналитички компаратив \{#analytic-comparative}
...
### Неправилна поређења \{#irregular-comparatives}
...
### Додатни обрасци \{#additional-forms}
