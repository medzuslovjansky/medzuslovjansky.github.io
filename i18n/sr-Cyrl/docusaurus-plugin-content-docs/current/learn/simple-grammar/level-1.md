...
## Абецеда и изговор \{#alphabet-and-pronunciation}
...
### Личне заменице \{#personal-pronouns}
...
### Релативне заменице \{#relative-pronouns}
...
### Упитне и неодређене заменице \{#interrogative-and-indefinite-pronouns}
...
## Пример текста: У ресторану \{#sample-text-in-the-restaurant}
...
## Основни речник \{#basic-vocabulary}
