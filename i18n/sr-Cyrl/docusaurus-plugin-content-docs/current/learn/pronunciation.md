...
3. Осим `a` `e` `ě` `i` `o` `u` `y`, , слово `r` може бити и самогласник. То је случај када се појављује иза сугласника, а не прати самогласник, што резултира такозваним _слоготворним р_: :isv[trg] :ipa[tərg], :isv[cukr] :ipa[ʦukər].
