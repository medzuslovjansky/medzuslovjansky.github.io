...
### Интернационални насупрот словенском речнику \{#international-versus-slavic-vocabulary}
...
- интернационални речник, речи које су уобичајене у многим, чак и неповезаним језицима. Већина је позајмљена директно или индиректно из латинског и грчког (:isv[filozofija], :isv[universitet], :isv[material], :isv[motor]), понекад долази из других језика (:isv[bjuro], :isv[fajl], :isv[jaguar], :isv[čaj], :isv[šokolad]), у ретким случајевима чак и из самог словенског (:isv[vampir], :isv[vodka])
...
Мала разлика у значењу између језика не би требало да представља нужно проблем (нпр. :isv[ljubiti] значи „волети“ на већини словенских језика, али „волети“ на пољском). И заиста велике разлике у значењу ретко изазивају проблеме, посебно када припадају различитим категоријама речи (нпр. :sla[pet] \~ :sla[peť] \~ :sla[peć] \~ :sla[piec], носећи значења попут „пет“, „пећ“, „опушак“ и „певати“). У оба случаја шансе за неспоразум су мале. Лажни пријатељи су проблематични само када се реч, упркос озбиљној разлици у значењу, ипак може користити у истом или сличном контексту и стога је вероватно различито разумети Словени различитих националности. Горе поменута реч :isv[listopad], која значи „новембар“ на пољском/чешком и „октобар“ на хрватском, је пример. Очигледно, такве речи треба избегавати у међусловенским текстовима.

### Неологизми \{#neologisms}

У контексту међусловенског, неологизми су речи које као такве не постоје ни у једном од живих словенских језика. Примери таквих речи су портманто речи (на пример :isv[katka] „патка“, из ру. :ru[utka], пол. :pl[kaczka], јужнословенски :zls[patka]), калкови из несловенских језика (нпр. :isv[kolokrěslo] „инвалидска колица“), комбинације међусловенских корена речи са међусловенским афиксима којих у словенском нема (на пример :isv[gradnik] „грађанин, грађанин“), и речи описнијег карактера у случајевима када је немогуће наћи широко разумљиву словенску реч.

Мишљења се разликују о степену у коме су вештачки створене речи прихватљиве у међусловенском; неки људи их воле, други их мрзе. У речнику тежимо да избегавамо неологизме, осим ако ниједан од живих словенских језика не пружи реч која је разумљива широј публици и која неће бити погрешно схваћена од стране других. Пример је :isv[časina] „час“ (старословенски садржи две речи: :isv[čas] и :isv[godina], али прва значи „време“ на западнословенском, друга значи „година“ на јужнословенском, док српскохрватска реч :hbs[sat] је турска реч која другим Словенима уопште није разумљива).
...
На пример, општесловенске секвенце `tj/dj` постају `č/ž` у источнословенском, `c/dz` у пољском, `c/z` у чехословачком, `č/j` у словеначком, `ć/đ` у српско-хрватском, `ḱ/ǵ` у македонски и `št/žd` на бугарском. Најбољи компромис овде је вероватно `č/dž` (нпр. :isv[svěča] „свећа“ и :isv[medžu] „између“), што има додатну предност у томе што је ово друго звучни еквивалент првог и на тај начин ствара симетрију.
...
Најједноставнији облик међусловенског, :isv[Slovianto], заправо није језик, већ метод који могу да користе несловени као метод за учење и/или коришћење међусловенског. Састоји се од три различита нивоа, од којих сваки ученику приближава „прави“ међусловенски.
