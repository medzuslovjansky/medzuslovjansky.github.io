...
Да, постоји прототип [аутоматског преводиоца за међусловенски][2]. Он је функционалан, али и даље захтева даљи развој и побољшање његових могућности од стране програмера.
...
Међусловенски језик је пројекат који је у сталном развоју и могуће је да нећете увек моћи да пронађете реч која вам је потребна [у речнику][1]. У том случају:

- прво потражите синониме;
- претражујте речник користећи бота на [Discord сервер][3] или [Telegram Messenger][5];
