...
## Назив :notr[Medžuslovjansky] \{#the-name-medžuslovjansky}
...
- :notr[**Medžuslovjansky**] што значи „међусловенски“ и може се схватити као назив језика који служи за комуникацију између Словена различитих националности.
...
2011\. године назив :notr[_Medžuslovjansky_] је изабран као заједнички назив за све међусловенске пројекте. Пошто су 2017. године :notr[_Slovianski_] и :notr[_Novoslovjanski_] спојени у један језик, он је постао :notr[_Medžuslovjansky_].
