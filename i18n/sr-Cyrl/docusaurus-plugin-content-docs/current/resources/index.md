...
## Заједница и друштвене мреже \{#community-and-social-networks}
...
### Телеграм микроблогови \{#telegram-microblogs}

- [:notr[Pub "Medžuslovjanska Kapibara"]][7] – редовно се ажурира забавним садржајем.
- [:notr[Zapisky srědnoevropskogo medžuslovjanina]][8] – микроблог Роберта Ломбина.

### Подкасти \{#podcasts}

Слушајте наше препоручене подкасте за јединствено аудитивно искуство учења:

- [Међусловенске вести][9]
- [:notr[Medžuslovjansky Slovotok]][10]
- [:notr[Radio Dupa FM]][11]

### Преводи песама \{#song-translations}

Певајте уз преводе својих омиљених песама на међусловенском на [:notr[LyricsTranslate]][12].

## Читање \{#reading}

За вежбање читања препоручујемо следеће књиге:

- Мали принц (латиница): [http://steen.free.fr/interslavic/maly\_princ\_lat.pdf][13]
- Мали принц (ћирилично писмо): [http://steen.free.fr/interslavic/maly\_princ\_kir.pdf][14]
- :notr[Medžuslovjansky Čitateljnik]: [https://www.ceeol.com/search/chapter-detail?id=791191][15]
- Часопис ":notr[Slovjani]": [https://slovjani.info][16] - има неколико чланака на међусловенском, али није часопис на језику.

## Приручници \{#handbooks}
...
### Провера правописа \{#spell-checkers}

Провера правописа је кључна за учење новог језика. Ево неких које препоручујемо.

#### :notr[Firefox] \{#firefox}

Ако сте корисник :notr[Firefox]-а, можете да додате проверу правописа међусловенског језика из [:notr[Firefox] продавнице додатака][20].

#### :notr[LibreOffice] \{#libreoffice}

Корисници :notr[LibreOffice]-а могу да инсталирају међусловенску проверу правописа са [овде][21].

#### :notr[Hunspell] \{#hunspell}

За директно преузимање: [https://github.com/medzuslovjansky/isv\_hunspell\_dict/releases][22]

### Транслитератор \{#transliterator}
...
- Међусловенски речник - [https://github.com/sonic16x/interslavic][27]
- Међусловенска организација ОСС – [https://github.com/medzuslovjansky][28]
- Складишта о Интерславиц-у: [https://github.com/search?q=topic%3Ainterslavic\&type=repositories][29]

### Стрипови \{#comics}

Да би учење било пријатније, погледајте овај међусловенски стрип на [:notr[Slovene Online]][30].

## Веб-сајтови \{#websites}
