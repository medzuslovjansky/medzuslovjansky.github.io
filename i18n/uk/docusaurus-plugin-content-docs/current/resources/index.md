...
## Спільнота та соціальні мережі \{#community-and-social-networks}
...
### Мікроблоги Telegram \{#telegram-microblogs}

- [:notr[Pub "Medžuslovjanska Kapibara"]][7] – регулярно оновлюється цікавим контентом.
- [:notr[Zapisky srědnoevropskogo medžuslovjanina]][8] – мікроблог Роберто Ломбіно.
...
### Переклади пісень \{#song-translations}

Співайте разом із перекладами ваших улюблених пісень міжслов’янською на [:notr[LyricsTranslate]][12].
...
- Журнал ":notr[Slovjani]": [https://slovjani.info][16] - в ньому є деякі статті міжслов'янською мовою, але це не мовний журнал.
...
### Перевірка орфографії \{#spell-checkers}
...
Щоб зробити навчання приємнішим, перегляньте цей міжслов’янський комікс на [:notr[Slovene Online]][30].
