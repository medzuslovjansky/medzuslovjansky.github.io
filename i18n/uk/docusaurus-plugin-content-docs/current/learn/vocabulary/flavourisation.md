...
Крім того, у північних інфінітивах ароматизації закінчуються на `-ť` замість `-ti`, називний/знахідний відмінок однини прикметників має бути `-e` замість `-o` (:isv[dobre detja] замість південного :isv[dobro děte]). Північна ароматизація надає перевагу відносному займеннику :isv[ktory], а південна – :isv[koj]. Подібним чином, у випадку префікса `vy-`/`iz-`, перший орієнтований на північ, другий – на південь. У південній ароматизації прийменник :isv[dlja] «за» слід замінити на :isv[za].
