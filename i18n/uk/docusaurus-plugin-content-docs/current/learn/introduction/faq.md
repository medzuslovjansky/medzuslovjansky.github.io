...
- **Меджуслов'янський** - це мова безпосередньо приблизно всім слов'янсько-язичним людям без навчання.
- **Меджуслов'янський** - це мова, зрозуміла без навчання майже всім слов'яномовним.
...
Міжслов'янська латиниця має лише чотири літери з діакритикою: Č :ipa[t͡ʃ], Š :ipa[ʂ], Ž :ipa[ʒ], Ě :ipa[jɛ]. Однак деякі люди використовують додаткові діакритичні знаки та літери, щоб запам’ятати слов’янську етимологію, тому час від часу ви можете зустріти такі дивні слова, як :isv[ćuđi], :isv[otėc], :isv[dȯžď], :isv[gręź], :isv[bųde], :isv[hlåd], :isv[сѫглӑсък], :isv[тѣх], :isv[гѫбоѭ], :isv[показуѥт].
