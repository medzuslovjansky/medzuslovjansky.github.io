...
### Основні закінчення \{#basic-endings}
...
### Аналітичний порівняльний \{#analytic-comparative}
...
### Синтетичне порівняння \{#synthetic-comparative}
...
### Нерегулярні порівняння \{#irregular-comparatives}
...
### Додаткові форми \{#additional-forms}
