...
## Алфавіт і вимова \{#alphabet-and-pronunciation}
...
### Питальні та неозначені займенники \{#interrogative-and-indefinite-pronouns}
...
## Приклад тексту: У ресторані \{#sample-text-in-the-restaurant}
...
## Базовий словниковий запас \{#basic-vocabulary}
