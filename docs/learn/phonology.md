...
The soft consonants also include postalveolar :isv[`š`], :isv[`ž`], :isv[`č`] and :isv[`dž`], as well as the affricates :isv[`ć`] and :isv[`đ`].
...
In noun declension, however, the soft counterpart of :isv[`y`] is always :isv[`e`].
