...
In addition, in the Northern flavourisation infinitives end in `-ť` instead of `-ti`, the nominative/accusative singular of adjectives should be `-e` instead of `-o` (:notr[dobre detja] instead of Southern :notr[dobro děte]). The Northern flavourisation favours the relative pronoun :isv[ktory] whereas the Southern flavourisation favours :isv[koj]. Likewise, in the case of the prefix **`vy`-/`iz`-**, the former is North-oriented, the latter South-oriented. In the Southern flavourisation the preposition :isv[dlja] „for” should be substituted with _`za`_.
