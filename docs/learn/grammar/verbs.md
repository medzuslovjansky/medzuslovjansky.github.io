...
For example: :isv[Igor jezdil po Moskvě] „Igor was driving around in Moscow”. :isv[Igor jehal do Moskvy] „Igor was driving to Moscow”. :isv[Igor pojehal do Moskvy] „Igor has gone to Moscow”.

When a non-directional verb of motion has a direction anyway, this expresses a habit: :isv[Igor jezdil do Moskvy] „Igor \[always|often] went to Moscow”.
...
In compounds with a prefix, the non-directional form is used for the imperfective verb, the directional form for the perfective verb:
...
- First conjugation:
  ...
  - verbs on `-ati`, monosyllabic stems ending in a vowel, and a number of verbs on `-ěti` have `-j-` added to the infinitive stem: :isv[dělati] > :isv[dělaj-], :isv[uměti] > :isv[uměj-], :isv[biti] > :isv[bij-], :isv[čuti] > :isv[čuj-]
...
A past conditional can be formed by inserting the past tense of the verb „to be” into the normal conditional form:
...
The **past active participle** is based on the infinitive stem of a perfective verb, followed by `-vši` if it ends in a vowel or `-ši` if it ends in a consonant. For example: :isv[sdělati] > :isv[sdělavši] „having done”, :isv[ukrasti] (< :isv[ukrad-ti]) > :isv[ukradši] „having stolen”. Like the present active participle, it can both be adjectival and adverbial, but its usage as an adjective is very rare. Note that the past active participle is a very bookish form that exists in most Slavic languages, but is hardly ever used in spoken Slavic.
...
- Verbs on `-iti` have `-jeny` instead of **\*-`iny`** (whereby **\*-`sjeny`, \*-`zjeny`, \*-`tjeny`, \*-`djeny`, \*-`stjeny`, \*-`zdjeny`** become **-`šeny`, -`ženy`, -`čeny`, -`dženy`, -`ščeny`, -`ždženy`**): :isv[govoriti] > :isv[govorjeny] „spoken”, :isv[ljubiti] > :isv[ljubjeny] „loved”, :isv[prositi] > :isv[prošeny] „required”
...
The passive voice is created by combining a form of the verb :isv[byti] „to be” with a passive participle. In the present tense, this participle can be the past passive participle or the present passive participle of an imperfective verb:
