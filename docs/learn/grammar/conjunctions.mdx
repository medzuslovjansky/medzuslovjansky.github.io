...
:isv[na] (_+ `loc`._) – on, at; (_+ `acc`._) – on(to), unto

:isv[v, vo] (_+ `loc`._) – in, within; (_+ `acc`._) – into
...
:isv[bez obzira na] (_+ `acc`._) – regardless\
:isv[čto se tyče] (_+ `gen`._) – regarding, with regard to\
:isv[na prěkor] (_+ `gen`._) – in defiance of\
:isv[ne gledajuči na] (_+ `acc`._) – disregarding, despite, in spite of, notwithstanding\
:isv[od strany] (_+ `gen`._) – by, on the part of\
:isv[po odnošenju k] (_+ `dat`._) – regarding, with regard to\
:isv[pod vodstvom] (_+ `gen`._) – under the leadership of\
:isv[s izključenjem] (_+ `gen`._) – except, with the exception of\
:isv[s obzirom na] (_+ `acc`._) – with regard to\
:isv[s pomočju] (_+ `gen`._) – with the help of\
:isv[sgodno s] (_+ `inst`._) – conform\
:isv[susedno do] (_+ `gen`._) – next to, neighbouring to

:isv[v času] (_+ `gen`._) – during\
:isv[v imenu] (_+ `gen`._) – in the name of\
:isv[v obličju] (_+ `gen`._) – in the face of\
:isv[v odrazlikě od] (_+ `gen`._) – unlike, in contrast to\
:isv[v odnošenju k] (_+ `dat`._) – regarding, with regard to\
:isv[v ramah, v ramkah] (_+ `gen`._) – within the framework of, as a part of\
:isv[v protivnosti k] (_+ `dat`._) – unlike, in opposition to\
:isv[v smyslu] (_+ `gen`._) – in the sense of\
:isv[v različju od] (_+ `gen`._) – unlike\
:isv[v svezi s] (_+ `inst`._) – in connection with\
:isv[v těčenju] (_+ `gen`._) – during\
:isv[v vrěmenu] (_+ `gen`._) – during\
:isv[v zaměn za] (_+ `acc`._) – instead of, in exchange for
