...
* The tens (10-90) consist of :isv[deset] for 10, and for 20-90, the numbers 2-9 with the suffix :isv[-deset] (e.g., :isv[dvadeset], :isv[trideset]), as shown in the third column.
* The hundreds (100-900) can be formed in two ways, as shown in the fourth column:
  * :isv[sto] for 100, and for 200-900, either by adding the numbers 2-9 to :isv[-sto] (e.g., :isv[dvasto], :isv[tristo])
...
Most Slavic languages use the ordinal numbers for fractions: :isv[dvě trětje] „two thirds, 2/3”. However, for reasons of clarity it would deserve recommendation to use the following, universally understandable forms instead:
