...
import PronAlphabet from '@site/src/markdown/pronunciation-of-the-alphabet.jsx';
...
<PronAlphabet
  A={<>as a in f<b>a</b>ther</>}
  B={<>as b in <b>b</b>ook</>}
  C={<>as ts in bi<b>ts</b></>}
  Č={<>as ch in <b>ch</b>ur<b>ch</b></>}
  D={<>as d in <b>d</b>eer</>}
  DŽ={<>as j in <b>J</b>ohn</>}
  E={<>as e in b<b>e</b>st</>}
  Ě={<>as ye in <b>ye</b>t</>}
  F={<>as f in <b>f</b>orest</>}
  G={<>as g in <b>g</b>ood</>}
  H={<>as ch in Scottish "lo<b>ch</b>"</>}
  I={<>as ea in b<b>ea</b>t</>}
  J={<>as y in <b>y</b>ard</>}
  K={<>as in English, but without aspiration</>}
  L={<>as in English</>}
  LJ={<>as li in mil<b>li</b>on</>}
  M={<>as m in <b>m</b>op</>}
  N={<>as n in <b>n</b>eat</>}
  NJ={<>as ny in ca<b>ny</b>on</>}
  O={<>as o in <b>o</b>r</>}
  P={<>as in English, but without aspiration</>}
  R={<>rolled r</>}
  S={<>as s in <b>s</b>pin</>}
  Š={<>as sh in <b>sh</b>op</>}
  T={<>as in English, but without aspiration</>}
  U={<>as oo in b<b>oo</b>k</>}
  V={<>as v in a<b>v</b>oid</>}
  Y={<>as i in b<b>i</b>t</>}
  Z={<>as z in <b>z</b>oo</>}
  Ž={<>as si in vi<b>si</b>on</>}
/>
