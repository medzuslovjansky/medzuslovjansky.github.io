...
8. Likewise, a consonant is inherently soft before `j` as well, unless this consonant is part of a prefix: :isv[žitje] is pronounced :isv[žiťje], but in the word :isv[odjehati] the `d` remains hard.
