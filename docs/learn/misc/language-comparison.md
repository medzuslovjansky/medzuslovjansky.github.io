...
Before Interslavic was (re)started in 2006 under the name „:notr[Slovianski]”, there had been dozens of other Slavic-based language projects. By then, the older ones were obsolete and forgotten, while the more recent ones were underdeveloped one-man projects – with one notorious exception: :notr[**Slovio**], a fairly well-known project with a complete grammar and a large dictionary. Some have asked: **why start a new project if there is already one such language around?**

Indeed, :notr[Slovio] and Interslavic are both Slavic-based auxiliary languages, but that is where the similarity ends. :notr[Slovio] is the self-proclaimed language of radical pan-Slavism, yet it also claims to be _„:notr[universalju]”_, a language for the whole world. Whatever be its true purpose, it is well worth mentioning that :notr[Slovio] is not very Slavic at all: its grammar is almost entirely based on Esperanto, its word building mechanisms are mostly Germanic, and its vocabulary, although clearly dominated by (often mutilated) Russian words, does not relate in any predictable way to the Slavic languages either. As a result, its educational value is practically zero. Because of its artificial and un-Slavic character, :notr[Slovio] has never succeeded in gaining any acceptation among Slavs. In addition, all :notr[Slovio] activity has practically died out in 2011.

Unlike :notr[Slovio], Interslavic is entirely based on common Slavic material. It is neither intended to become a world language, nor to serve as the language of a speaker community, nor to propagate any political ideology. It is merely a tool for communication and education, not a purpose in itself.

Sadly, :notr[Slovio]'s creator has deliberately been spreading false information about other Interslavic projects and even resorted to promoting :notr[Slovio] under their names. To avoid confusion, it should be emphasised that Interslavic and :notr[Slovio] are completely unrelated projects. See the [disclaimer](../introduction/index.md#disclaimer) for a short explanation.
