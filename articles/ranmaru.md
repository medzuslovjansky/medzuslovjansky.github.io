...
Соответственно, в ряде случаев это привело к фонетическим чередованиям, которые в межславянском языке выглядят, как k>č, g>ž, h>š (и c>č в результате наложения двух палатализаций). Чередования этого типа, к примеру, можно увидеть:
